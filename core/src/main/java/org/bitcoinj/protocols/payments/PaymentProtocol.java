...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/worldcoin-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/worldcoin-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/worldcoin-paymentack";
