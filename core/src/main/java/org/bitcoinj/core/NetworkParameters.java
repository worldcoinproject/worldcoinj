...
public abstract class NetworkParameters implements Serializable {
     ...
     */
    public static final int PROTOCOL_VERSION = 75000;

    /**
     * The alert signing key originally owned by Satoshi, and now passed on to Gavin along with a few others.
     */
    public static final byte[] SATOSHI_KEY = Utils.HEX.decode("0401b9104fc1213d7cb64ed61605862617a78b6f66f25c41973d50dbda6a8fdd3ee76111fa6be2afaaf9a8a1757e988fa371af35ab1d9eae20d8ff5436bee74e24");
    ...
    public static final String ID_REGTEST = "org.worldcoin.regtest";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.worldcoin.unittest";
     ...
     */
    public static final long MAX_COINS = 280000000;
...
/*    public int getTargetTimespan() {
    ...
    */
    public int getTargetTimespan(int height) {
        ...
        if(height <= 600000) return TARGET_TIMESPAN; //targetTimespan;
        return TARGET_TIMESPAN_RE; //targetTimespanNew;
    }
    public int getTargetTimespan(boolean newRules) {
        if (newRules)
            return TARGET_TIMESPAN_RE; //targetTimespanNew;
        else
            return TARGET_TIMESPAN; //targetTimespan;
    }
    ...
    public int getInterval(int height) {
        ...
        if(height <= 600000) return INTERVAL; //interval;
        return INTERVAL_RE; //intervalNew;
    }
