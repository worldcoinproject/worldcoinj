...
public class Block extends Message {
    ...
    public Coin getBlockInflation(int height) {
        return FIFTY_COINS.shiftRight(height / params.getSubsidyDecreaseBlockCount()); // TODO get real WDC code
    }
...
//                return new Sha256Hash.wrapReversed(scryptDigest(bos.toByteArray()));
            } catch (IOException e) {
                throw new RuntimeException(e); // Cannot happen.
            }
    }
