...
public class BitcoinURI {
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the worldcoin: prefix");
    ...
    private void parseParameters(@Nullable NetworkParameters params, String addressToken, String[] nameValuePairTokens) throws BitcoinURIParseException {
        ...
        for (String nameValuePairToken : nameValuePairTokens) {
            ...
            if (sepIndex == -1)
                throw new BitcoinURIParseException("Malformed Worldcoin URI - no separator in '" +
                        nameValuePairToken + "'");
            if (sepIndex == 0)
                throw new BitcoinURIParseException("Malformed Worldcoin URI - empty name '" +
                        nameValuePairToken + "'");
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("WorldcoinURI[");
        boolean first = true;
