...
package com.google.worldcoin.store;
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.google.worldcoin.core.BlockChain#getChainHead()}
     * or perhaps {@link com.google.worldcoin.core.BlockChain#getBestChainHeight()} which will run in constant time and
