...
public class AddressMessage extends Message {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(AddressMessage.class);
    ...
    void parse() throws ProtocolException {
        ...
        for (int i = 0; i < numAddresses; i++) {
            ...
            addresses.add(addr);
//            log.info("Added address:"+addr);
//            if(PeerGroup.uglyQuickHack!=null)PeerGroup.uglyQuickHack.addAddress(addr);
