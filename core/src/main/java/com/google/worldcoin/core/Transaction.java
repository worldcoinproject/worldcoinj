...
import com.google.worldcoin.crypto.TransactionSignature;
...
import static com.google.worldcoin.core.Utils.*;
...
public class Transaction extends ChildMessage implements Serializable {
     ...
     */
    public static final BigInteger REFERENCE_DEFAULT_MIN_TX_FEE = BigInteger.valueOf(1000000); // WDC 0.01
    ...
    // These are serialized in both worldcoin and java serialization.
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.worldcoin.script.Script, ECKey, com.google.worldcoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.worldcoin.core.Transaction.SigHash, boolean)}
    ...
    public synchronized Sha256Hash hashForSignature(int inputIndex, byte[] connectedScript, byte sigHashType) {
        ...
        //
        //   https://en.worldcoin.it/wiki/Contracts
