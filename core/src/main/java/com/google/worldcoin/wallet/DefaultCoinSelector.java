package com.google.worldcoin.wallet;
...
/**
 * This class implements a {@link com.google.worldcoin.wallet.CoinSelector} which attempts to get the highest priority
...
public class DefaultCoinSelector implements CoinSelector {
    ...
    public static boolean isSelectable(Transaction tx) {
        ...
        if (type.equals(TransactionConfidence.ConfidenceType.BUILDING)){
        	// In BTC when blocks take 10 mins, we're happy with 1 confirm, but in WDC SPV it's probably better not to spend money you've
        	// had for less than a minute or two. We want 2-5 confirms, 2 minutes (4 blocks) is a good compromise? 
        	if(confidence.getDepthInBlocks() > 2) return true;
        }
