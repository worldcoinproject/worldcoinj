...
/*        Address a = new Address(testParams, Hex.decode("fda79a24e50ff70ff42f7d89585da5bd19d9e5cc"));
        ...
        assertEquals("WbrPpz5pka1Fe3zQwZJQSkbhbcahUcR4g2", b.toString());
...
/*        Address a = new Address(testParams, "n4eA2nbYqErp7H6jebchxAN59DmNpksexv");
        ...
        Address b = new Address(mainParams, "WbrPpz5pka1Fe3zQwZJQSkbhbcahUcR4g2");
...
/*        // Check the case of a mismatched network.
    ...
    public void getNetwork() throws Exception {
        NetworkParameters params = Address.getParametersFromAddress("WbrPpz5pka1Fe3zQwZJQSkbhbcahUcR4g2");
