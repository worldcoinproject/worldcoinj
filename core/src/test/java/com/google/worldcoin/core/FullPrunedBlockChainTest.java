...
import com.google.worldcoin.store.FullPrunedBlockStore;
import com.google.worldcoin.store.MemoryFullPrunedBlockStore;
import com.google.worldcoin.utils.BlockFileLoader;
...
public class FullPrunedBlockChainTest {
    ...
    public void setUp() throws Exception {
        ...
        params = new UnitTestParams() {
            @Override public int getInterval(boolean newRules) {
                return 10000;
            }
        };
    }
