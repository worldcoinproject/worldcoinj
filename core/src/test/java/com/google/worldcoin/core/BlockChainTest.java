...
import com.google.worldcoin.store.MemoryBlockStore;
...
import static com.google.worldcoin.utils.TestUtils.createFakeBlock;
import static com.google.worldcoin.utils.TestUtils.createFakeTx;
...
public class BlockChainTest {
    ...
    public void difficultyTransitions() throws Exception {
        ...
        for (int i = 0; i < unitTestParams.getInterval(true) - 1; i++) { //FIXME
